...
Param(
    ...
    [string] $ResourceGroupName = 'deploy-web-app',
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageAccountResourceGroupName, 
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = '..\Templates\deploy-web-app.json',
    [string] $TemplateParametersFile = '..\Templates\deploy-web-app.parameters.json',
